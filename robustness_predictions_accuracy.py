# This Python codes to revise the accuracy data to required format and calculate the accuracy scores.
...
class MutationPredictions:
  ...
  def __init__(self):
    self.file_names = [f'mutation{i}.db' for i in range(1,11) if i != 2]
